...
export const trendingSerialsList: Array<SerialItemType> = [
  {
    id: 's1',
    title: 'Bridgerton',
    genre: 'Romance',
...
export const romanceSerialsList: Array<SerialItemType> = [
  {
    id: 's3',
    title: 'One day',
    genre: 'Romance',
...
export const episodesList: Array<EpisodeType> = [
  {
    title: 'Episode 1',
    id: 'e1',
